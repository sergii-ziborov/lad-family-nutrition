...
В прототипе работают семь дней меню с разными блюдами по дням, участники каждого приёма пищи, индивидуальные ручные порции, отметки съеденного отдельно от плана, девять **демонстрационных** открытых рецептов с шагами готовки, личное избранное и простой личный учёт добавок. Раздел «Продукты» хранит известные или неизвестные количества и сроки годности, предлагает весь список уникальных ингредиентов загруженных рецептов без лимита в 12 строк, поиск по синонимам («помидор» находит «Томаты») и ручное добавление. Синонимы учитываются также в запасах и покупках при совпадении единиц измерения. Покупки показывают потребность меню за вычетом известного запаса и происхождение каждой позиции. Подбор показывает недостающие ингредиенты; отметка «Закончилось» предлагает изменения будущего меню с подтверждением и отменой. Семейные профили и неделя хранятся в локальном аккаунте на iPhone; имена и возраст пилотной семьи можно обновить с защищённого сервера Hetzner. Личные настройки порций, калорийного ориентира и ограничений остаются локальными.
