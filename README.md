...
В прототипе работают семь дней меню с разными блюдами по дням, участники каждого приёма пищи, индивидуальные ручные порции, отметки съеденного отдельно от плана, девять **демонстрационных** открытых рецептов с шагами готовки, личное избранное и простой личный учёт добавок. Раздел «Продукты» хранит известные или неизвестные количества и сроки годности, предлагает поиск по ингредиентам и ручное добавление. Покупки показывают потребность меню за вычетом известного запаса и происхождение каждой позиции. Подбор показывает недостающие ингредиенты; отметка «Закончилось» предлагает изменения будущего меню с подтверждением и отменой. Семейные профили и неделя хранятся в локальном аккаунте на iPhone; имена и возраст пилотной семьи можно обновить с защищённого сервера Hetzner. Личные настройки порций, калорийного ориентира и ограничений остаются локальными.
...
Фотографии блюд и иконка созданы для проекта встроенным генератором изображений. Три снимка открытых демо-блюд и иконка входят в репозиторий; 13 изображений закрытых рецептов лежат в исключённой из Git папке `private-assets/` и на защищённом сервере. Переписывание текста и новая иллюстрация сами по себе не подтверждают права на публикацию исходного рецепта: перед коммерческим релизом нужен отдельный правовой и редакционный аудит.
